...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/mwhittaker/calculator/4/calc/Adder",
		Iface: reflect.TypeOf((*Adder)(nil)).Elem(),
		Impl:  reflect.TypeOf(adder{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return adder_local_stub{impl: impl.(Adder), tracer: tracer, addMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/calculator/4/calc/Adder", Method: "Add", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return adder_client_stub{stub: stub, addMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/calculator/4/calc/Adder", Method: "Add", Remote: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦a6798bb1:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/mwhittaker/calculator/4/calc/Adder⟧\n⟦e62876fe:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/mwhittaker/calculator/4/calc/Multiplier⟧\n⟦41990618:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→calc⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "github.com/mwhittaker/calculator/4/calc/Multiplier",
		Iface: reflect.TypeOf((*Multiplier)(nil)).Elem(),
		Impl:  reflect.TypeOf(multiplier{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return multiplier_local_stub{impl: impl.(Multiplier), tracer: tracer, multiplyMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/calculator/4/calc/Multiplier", Method: "Multiply", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return multiplier_client_stub{stub: stub, multiplyMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/calculator/4/calc/Multiplier", Method: "Multiply", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
			return multiplier_server_stub{impl: impl.(Multiplier), addLoad: addLoad}
		},
		ReflectStubFn: func(caller func(string, context.Context, []any, []any) error) any {
			return multiplier_reflect_stub{caller: caller}
		},
		RefData: "",
	})
}
...
var _ weaver.InstanceOf[Multiplier] = (*multiplier)(nil)

// weaver.Router checks.
var _ weaver.Unrouted = (*adder)(nil)
var _ weaver.Unrouted = (*Server)(nil)
var _ weaver.Unrouted = (*multiplier)(nil)
...
// Check that multiplier_local_stub implements the Multiplier interface.
var _ Multiplier = (*multiplier_local_stub)(nil)

func (s multiplier_local_stub) Multiply(ctx context.Context, a0 int, a1 int) (r0 int, err error) {
	// Update metrics.
	begin := s.multiplyMetrics.Begin()
	defer func() { s.multiplyMetrics.End(begin, err != nil, 0, 0) }()
	span := trace.SpanFromContext(ctx)
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "main.Multiplier.Multiply", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
// Check that multiplier_client_stub implements the Multiplier interface.
var _ Multiplier = (*multiplier_client_stub)(nil)

func (s multiplier_client_stub) Multiply(ctx context.Context, a0 int, a1 int) (r0 int, err error) {
	// Update metrics.
	var requestBytes, replyBytes int
	begin := s.multiplyMetrics.Begin()
	defer func() { s.multiplyMetrics.End(begin, err != nil, requestBytes, replyBytes) }()

	span := trace.SpanFromContext(ctx)
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "main.Multiplier.Multiply", trace.WithSpanKind(trace.SpanKindClient))
	}
...
// Check that multiplier_server_stub implements the codegen.Server interface.
var _ codegen.Server = (*multiplier_server_stub)(nil)
...
type multiplier_reflect_stub struct {
	caller func(string, context.Context, []any, []any) error
}

// Check that multiplier_reflect_stub implements the Multiplier interface.
var _ Multiplier = (*multiplier_reflect_stub)(nil)

func (s multiplier_reflect_stub) Multiply(ctx context.Context, a0 int, a1 int) (r0 int, err error) {
	err = s.caller("Multiply", ctx, []any{a0, a1}, []any{&r0})
	return
}
