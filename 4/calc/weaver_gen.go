...
func (s multiplier_local_stub) Multiply(ctx context.Context, a0 int, a1 int) (r0 int, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "calc.Multiplier.Multiply", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s multiplier_client_stub) Multiply(ctx context.Context, a0 int, a1 int) (r0 int, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "calc.Multiplier.Multiply", trace.WithSpanKind(trace.SpanKindClient))
	}
