...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/mwhittaker/calculator/2/adder/Adder",
		Iface: reflect.TypeOf((*Adder)(nil)).Elem(),
		Impl:  reflect.TypeOf(adder{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return adder_local_stub{impl: impl.(Adder), tracer: tracer, addMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/calculator/2/adder/Adder", Method: "Add", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return adder_client_stub{stub: stub, addMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/calculator/2/adder/Adder", Method: "Add", Remote: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦5cb50cda:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/mwhittaker/calculator/2/adder/Adder⟧\n⟦8ceb5c07:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→adder⟧\n",
	})
}
...
func (s adder_local_stub) Add(ctx context.Context, a0 int, a1 int) (r0 int, err error) {
	...
	if span.SpanContext().IsValid() {
		...
		ctx, span = s.tracer.Start(ctx, "adder.Adder.Add", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
...
func (s adder_client_stub) Add(ctx context.Context, a0 int, a1 int) (r0 int, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "adder.Adder.Add", trace.WithSpanKind(trace.SpanKindClient))
	}
...
ERROR: You generated this file with 'weaver generate' v0.21.3-0.20231006165419-acafb2ee179c (codegen
