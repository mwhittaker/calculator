...
type AdderClient interface {
	Add(ctx context.Context, in *Summands, opts ...grpc.CallOption) (*Sum, error)
}
...
func (c *adderClient) Add(ctx context.Context, in *Summands, opts ...grpc.CallOption) (*Sum, error) {
	out := new(Sum)
...
type AdderServer interface {
	Add(context.Context, *Summands) (*Sum, error)
...
func (UnimplementedAdderServer) Add(context.Context, *Summands) (*Sum, error) {
...
func _Adder_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdderServer).Add(ctx, req.(*Summands))
	}
