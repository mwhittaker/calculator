module github.com/mwhittaker/calculator/3b/calc

go 1.21

require (
	github.com/ServiceWeaver/weaver v0.21.3-0.20231005224231-991d5ec5bce4
	github.com/mwhittaker/calculator/3b/multiplier v0.0.0-20231011195759-08b52a8e4cd9
